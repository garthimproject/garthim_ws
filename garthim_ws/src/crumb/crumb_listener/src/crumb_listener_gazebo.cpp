...
// #include <gazebo/gazebo.hh>  // commented by varevalo
#include <gazebo/gazebo_client.hh> // needed from gazebo 4.X
...
{
  // Load gazebo
//  gazebo::setupClient(_argc, _argv); // commented by varevalo

  gazebo::client::setup(_argc, _argv); // needed from gazebo 4.X
