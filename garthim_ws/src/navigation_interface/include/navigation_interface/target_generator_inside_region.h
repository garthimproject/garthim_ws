#ifndef __TARGET_GENERATOR_INSIDE_REGION_GARTHIM_H__
#define __TARGET_GENERATOR_INSIDE_REGION_GARTHIM_H__
#include <ros/ros.h>
...
namespace navigation_interface {
     ...
     * 
     */
    class TargetGeneratorInsideRegion : public TargetGenerator {
        private:
            /**
